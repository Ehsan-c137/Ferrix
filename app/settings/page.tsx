    ...
    <div className="m-4">
      ...
      >
        <AccordionItem value="appearance">
          ...
          <AccordionContent className="flex flex-col gap-4">
            <p className="text-sm text-muted-foreground">
              Choose how Ferrix looks. Switch between light, dark, or follow
        ...
        <AccordionItem value="plugins">
          ...
          <AccordionContent className="flex flex-col gap-4">
            <p className="text-sm text-muted-foreground">
              Extend Ferrix with community-made integrations (sites, auth flows,
              post-processing, and more). A plugin store and developer docs are
              on the way.
            </p>
        ...
        <AccordionItem value="download-builder">
          ...
          <AccordionContent className="flex flex-col gap-4">
            <p className="text-sm text-muted-foreground">
              Configure how new downloads are created by default—chunk size,
              concurrency, verification strategy, user-agent, proxy profile, and
              automatic post-actions. Presets will let you switch profiles
              quickly.
            </p>
            ...
            <div className="space-y-2">
              ...
              <Select disabled value="default">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="high-throughput">
                    High Throughput
                  </SelectItem>
